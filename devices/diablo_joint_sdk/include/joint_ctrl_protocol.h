...
typedef struct
{
    ...
    uint16_t frame_cnt;
    uint16_t mode_check;
    int16_t left_hip_pos;
    int16_t left_knee_pos;
    int16_t left_wheel_vel;
    int16_t right_hip_pos;
    int16_t right_knee_pos;
    int16_t right_wheel_vel;
    int16_t CRC16;
} __attribute__((packed)) motor_pos_t;
